...
namespace SFB.Web.Common
{
    public class BenchmarkCriteria
    {
        ...
        [DBField(name: SchoolTrustFinanceDBFieldNames.LA, type: CriteriaFieldComparisonTypes.EQUALTO)]
        public int? LocalAuthorityCode { get; set; }

        [PrettyName(SchoolCharacteristicsQuestions.PFI)]
        [DBField(name: SchoolTrustFinanceDBFieldNames.PFI, type: CriteriaFieldComparisonTypes.EQUALTO)]
        public string[] Pfi { get; set; }

        [PrettyName(SchoolCharacteristicsQuestions.DOES_THE_SCHOOL_HAVE6_FORM)]
        [DBField(name: SchoolTrustFinanceDBFieldNames.HAS_6_FORM, type: CriteriaFieldComparisonTypes.EQUALTO)]
        public string SixthForm { get; set; }

        [PrettyName(SchoolCharacteristicsQuestions.GENDER_OF_PUPILS)]
        [DBField(name: SchoolTrustFinanceDBFieldNames.GENDER, type: CriteriaFieldComparisonTypes.EQUALTO)]
        public string[] Gender { get; set; }        

        [PrettyName(SchoolCharacteristicsQuestions.SCHOOL_OVERALL_PHASE)]
        [DBField(name: SchoolTrustFinanceDBFieldNames.SCHOOL_OVERALL_PHASE, type: CriteriaFieldComparisonTypes.EQUALTO)]
        ...
        [DBField(name: SchoolTrustFinanceDBFieldNames.URBAN_RURAL, type: CriteriaFieldComparisonTypes.EQUALTO)]
        ...
        [DBField(name: SchoolTrustFinanceDBFieldNames.MEMBER_COUNT, type: CriteriaFieldComparisonTypes.MIN)]
        public int? MinNoSchools { get; set; }

        [PrettyName(TrustCharacteristicsQuestions.NUMBER_OF_SCHOOLS)]
        [Range(2, Int32.MaxValue)]
        [DBField(name: SchoolTrustFinanceDBFieldNames.MEMBER_COUNT, type: CriteriaFieldComparisonTypes.MAX)]
        ...
        [Range(0, Int32.MaxValue)]
        [DBField(docName: SchoolTrustFinanceDBFieldNames.SCHOOL_OVERALL_PHASE_BREAKDOWN, name: SchoolTrustFinanceDBFieldNames.SCHOOL_OVERALL_PHASE_CROSS_PRIMARY, type: CriteriaFieldComparisonTypes.MIN)]
        public int? MinCrossPhasePrimary { get; set; }

        [PrettyName(TrustCharacteristicsQuestions.SCHOOL_OVERALL_PHASE)]
        [Range(0, Int32.MaxValue)]
        [DBField(docName: SchoolTrustFinanceDBFieldNames.SCHOOL_OVERALL_PHASE_BREAKDOWN, name: SchoolTrustFinanceDBFieldNames.SCHOOL_OVERALL_PHASE_CROSS_PRIMARY, type: CriteriaFieldComparisonTypes.MAX)]
        public int? MaxCrossPhasePrimary { get; set; }

        [PrettyName(TrustCharacteristicsQuestions.SCHOOL_OVERALL_PHASE)]
        [Range(0, Int32.MaxValue)]
        [DBField(docName: SchoolTrustFinanceDBFieldNames.SCHOOL_OVERALL_PHASE_BREAKDOWN, name: SchoolTrustFinanceDBFieldNames.SCHOOL_OVERALL_PHASE_CROSS_SECONDARY, type: CriteriaFieldComparisonTypes.MIN)]
        public int? MinCrossPhaseSecondary { get; set; }

        [PrettyName(TrustCharacteristicsQuestions.SCHOOL_OVERALL_PHASE)]
        [Range(0, Int32.MaxValue)]
        [DBField(docName: SchoolTrustFinanceDBFieldNames.SCHOOL_OVERALL_PHASE_BREAKDOWN, name: SchoolTrustFinanceDBFieldNames.SCHOOL_OVERALL_PHASE_CROSS_SECONDARY, type: CriteriaFieldComparisonTypes.MAX)]
        public int? MaxCrossPhaseSecondary { get; set; }

        [PrettyName(TrustCharacteristicsQuestions.SCHOOL_OVERALL_PHASE)]
        [Range(0, Int32.MaxValue)]
        [DBField(docName: SchoolTrustFinanceDBFieldNames.SCHOOL_OVERALL_PHASE_BREAKDOWN, name: SchoolTrustFinanceDBFieldNames.SCHOOL_OVERALL_PHASE_CROSS_SPECIAL, type: CriteriaFieldComparisonTypes.MIN)]
        public int? MinCrossPhaseSpecial { get; set; }

        [PrettyName(TrustCharacteristicsQuestions.SCHOOL_OVERALL_PHASE)]
        [Range(0, Int32.MaxValue)]
        [DBField(docName: SchoolTrustFinanceDBFieldNames.SCHOOL_OVERALL_PHASE_BREAKDOWN, name: SchoolTrustFinanceDBFieldNames.SCHOOL_OVERALL_PHASE_CROSS_SPECIAL, type: CriteriaFieldComparisonTypes.MAX)]
        public int? MaxCrossPhaseSpecial { get; set; }

        [PrettyName(TrustCharacteristicsQuestions.SCHOOL_OVERALL_PHASE)]
        [Range(0, Int32.MaxValue)]
        [DBField(docName: SchoolTrustFinanceDBFieldNames.SCHOOL_OVERALL_PHASE_BREAKDOWN, name: SchoolTrustFinanceDBFieldNames.SCHOOL_OVERALL_PHASE_CROSS_PRU, type: CriteriaFieldComparisonTypes.MIN)]
        public int? MinCrossPhasePru { get; set; }

        [PrettyName(TrustCharacteristicsQuestions.SCHOOL_OVERALL_PHASE)]
        [Range(0, Int32.MaxValue)]
        [DBField(docName: SchoolTrustFinanceDBFieldNames.SCHOOL_OVERALL_PHASE_BREAKDOWN, name: SchoolTrustFinanceDBFieldNames.SCHOOL_OVERALL_PHASE_CROSS_PRU, type: CriteriaFieldComparisonTypes.MAX)]
        public int? MaxCrossPhasePru { get; set; }

        [PrettyName(TrustCharacteristicsQuestions.SCHOOL_OVERALL_PHASE)]
        [Range(0, Int32.MaxValue)]
        [DBField(docName: SchoolTrustFinanceDBFieldNames.SCHOOL_OVERALL_PHASE_BREAKDOWN, name: SchoolTrustFinanceDBFieldNames.SCHOOL_OVERALL_PHASE_CROSS_AP, type: CriteriaFieldComparisonTypes.MIN)]
        public int? MinCrossPhaseAP { get; set; }

        [PrettyName(TrustCharacteristicsQuestions.SCHOOL_OVERALL_PHASE)]
        [Range(0, Int32.MaxValue)]
        [DBField(docName: SchoolTrustFinanceDBFieldNames.SCHOOL_OVERALL_PHASE_BREAKDOWN, name: SchoolTrustFinanceDBFieldNames.SCHOOL_OVERALL_PHASE_CROSS_AP, type: CriteriaFieldComparisonTypes.MAX)]
        public int? MaxCrossPhaseAP { get; set; }

        [PrettyName(TrustCharacteristicsQuestions.SCHOOL_OVERALL_PHASE)]
        [Range(0, Int32.MaxValue)]
        [DBField(docName: SchoolTrustFinanceDBFieldNames.SCHOOL_OVERALL_PHASE_BREAKDOWN, name: SchoolTrustFinanceDBFieldNames.SCHOOL_OVERALL_PHASE_CROSS_AT, type: CriteriaFieldComparisonTypes.MIN)]
        public int? MinCrossPhaseAT { get; set; }

        [PrettyName(TrustCharacteristicsQuestions.SCHOOL_OVERALL_PHASE)]
        [Range(0, Int32.MaxValue)]
        [DBField(docName: SchoolTrustFinanceDBFieldNames.SCHOOL_OVERALL_PHASE_BREAKDOWN, name: SchoolTrustFinanceDBFieldNames.SCHOOL_OVERALL_PHASE_CROSS_AT, type: CriteriaFieldComparisonTypes.MAX)]
