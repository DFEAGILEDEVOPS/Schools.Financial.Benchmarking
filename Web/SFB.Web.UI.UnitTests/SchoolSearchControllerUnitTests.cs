...
namespace SFB.Web.UI.UnitTests
{
    ...
    {        
        ...
        private Mock<ISchoolApiService> _mockApiService;
        ...
        public void Setup()
        {
            ...
            _mockApiService = new Mock<ISchoolApiService>();            
        ...
        public async Task SearchActionReturnsSuggestionsViewIfResultEmpty()
        {
            ...
            var controller = new SchoolSearchController(_mockApiService.Object, _mockFilterBuilder.Object, _valService, _mockEdubaseDataService.Object, _mockEdubaseSearchService.Object, _mockTrustSearchService.Object);
        ...
        public async Task SearchActionReturnsSuggestionsViewIfSearchByLAName()
        {
            ...
            _mockApiService.Setup(m => m.GetLocalAuthorities()).Returns(() => laSearchResponse);
