...
namespace SFB.Web.UI.UnitTests
{
    public class HistoricalChartBuilderUnitTests
    {
        ...
        public void TotalExpenditureChartShouldNotBeInPercentageOfTotalMetricCharts()
        {
            ...
            var chartVMs = builder.Build(RevenueGroupType.Expenditure, ChartGroupType.All, EstabType.Academies, UnitType.PercentageOfTotal);
        ...
        public void TotalIncomeChartShouldNotBeInPercentageOfTotalMetricCharts()
        {
            ...
            var chartVMs = builder.Build(RevenueGroupType.Income, ChartGroupType.All, EstabType.Academies, UnitType.PercentageOfTotal);
        ...
        public void WorkforceHeadCountChartShouldNotBeInHeadcountPerFTEMetricCharts()
        {
            ...
            var chartVMs = builder.Build(RevenueGroupType.Workforce, ChartGroupType.All, EstabType.Academies, UnitType.HeadcountPerFTE);
        ...
        public void WorkforceHeadCountChartShouldNotBeInFTERatioToTotalFTEMetricCharts()
        {
            ...
            var chartVMs = builder.Build(RevenueGroupType.Workforce, ChartGroupType.All, EstabType.Academies, UnitType.FTERatioToTotalFTE);
        ...
        public void QTSChartShouldNotBeInRatioNumberOfPupilsPerMeasureMetricCharts()
        {
            ...
            var chartVMs = builder.Build(RevenueGroupType.Workforce, ChartGroupType.All, EstabType.Academies, UnitType.NoOfPupilsPerMeasure);
