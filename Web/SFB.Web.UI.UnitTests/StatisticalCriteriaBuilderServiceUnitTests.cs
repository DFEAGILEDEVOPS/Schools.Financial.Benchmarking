...
namespace SFB.Web.UI.UnitTests
{
    public class StatisticalCriteriaBuilderServiceUnitTests
    {
        ...
        public void BuildShouldApplySchoolPhaseToCriteria()
        {
            ...
            var criteria = builder.BuildFromSimpleComparisonCriteria(benchmarkSchool.HistoricalSchoolDataModels.Last(), true, true, true, true, 0);
        ...
        public void BuildShouldApplyPercentageMarginForNumberOfPupils()
        {
            ...
            var criteria = builder.BuildFromSimpleComparisonCriteria(benchmarkSchool.HistoricalSchoolDataModels.Last(), true, true, true, true, 5);
        ...
        public void BuildShouldApplyPercentageMarginForFreeSchoolMeals()
        {
            ...
            var criteria = builder.BuildFromSimpleComparisonCriteria(benchmarkSchool.HistoricalSchoolDataModels.Last(), true, true, true, true, 3);
        ...
        public void BuildShouldApplyPercentageMarginForSenRegister()
        {
            ...
            var criteria = builder.BuildFromSimpleComparisonCriteria(benchmarkSchool.HistoricalSchoolDataModels.Last(), true, true, true, true, 4);
        ...
        public void BuildShouldApplyLACriteria()
        {
            ...
            var criteria = builder.BuildFromSimpleComparisonCriteria(benchmarkSchool.HistoricalSchoolDataModels.Last(), true, true, true, true, 10);
        ...
        public void BuildShouldNotApplyOptionalCriteriaIfNotIncluded()
        {
            ...
            var criteria = builder.BuildFromSimpleComparisonCriteria(benchmarkSchool.HistoricalSchoolDataModels.Last(), false, false, false, false, 10);
