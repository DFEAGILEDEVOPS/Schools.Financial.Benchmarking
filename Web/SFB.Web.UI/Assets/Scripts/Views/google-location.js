(function (GOVUK, Views) {
    ...
    function GoogleLocationViewModel() {
        var findByTown = /** @type {!HTMLInputElement} */(document.getElementById('FindSchoolByTown'));
        var options = {
            types: ['geocode'],
    ...
    GoogleLocationViewModel.prototype = {
        ...
        bindEvents: function (autocomplete) {
            ...
            $("form").submit(function (e) {
                if ($("input#TownOrCity").attr("checked") === "checked" && $("input#FindSchoolByTown").val().length >= 2) {
