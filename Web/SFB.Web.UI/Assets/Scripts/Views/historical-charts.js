...
(function (GOVUK, Views) {
  ...
  var HistoricalCharts = {
    ...
    RebuildCharts: function (establishment) {
      ...
      var url = "/" + establishment + "/getcharts?urn=" + urnParameter + "&code=" + codeParameter + "&matno=" + matNoParameter + "&revgroup=" + tabParameter + "&chartGroup=" + chartGroupParameter + "&unit=" + unitParameter + "&term=" + termParameter + "&name=" + nameParameter + "&format=" + formatParameter;
      ;
