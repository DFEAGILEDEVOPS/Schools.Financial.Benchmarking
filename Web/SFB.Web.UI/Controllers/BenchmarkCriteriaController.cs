        ...
        {                                
            ...
            if (bicCriteria == null)
            {
                bicCriteria = new BestInClassCriteria()
                {
                    ...
                    NoPupilsMin = (decimal)benchmarkSchool.LatestYearFinancialData.PupilCount * (1 - CriteriaSearchConfig.BIC_DEFAULT_FLEX_PUPIL_COUNT),
                    NoPupilsMax = (decimal)benchmarkSchool.LatestYearFinancialData.PupilCount * (1 + CriteriaSearchConfig.BIC_DEFAULT_FLEX_PUPIL_COUNT),
                    PerPupilExpMin = (decimal)benchmarkSchool.LatestYearFinancialData.PerPupilTotalExpenditure * (1 - CriteriaSearchConfig.BIC_DEFAULT_FLEX_EXP_PP_MIN),
                    PerPupilExpMax = (decimal)benchmarkSchool.LatestYearFinancialData.PerPupilTotalExpenditure * (1 + CriteriaSearchConfig.BIC_DEFAULT_FLEX_EXP_PP_MAX),
