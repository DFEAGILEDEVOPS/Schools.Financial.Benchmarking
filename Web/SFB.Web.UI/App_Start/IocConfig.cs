...
namespace SFB.Web.UI
{
    public static class IocConfig
    {
        ...
        private static void RegisterServices(ContainerBuilder builder)
        {
            ...
            //builder.RegisterInstance(new RedDogTrustSearchService(ConfigurationManager.AppSettings["SearchInstance"], ConfigurationManager.AppSettings["SearchKey"], ConfigurationManager.AppSettings["SearchIndexTrust"])).As<ITrustSearchService>();
