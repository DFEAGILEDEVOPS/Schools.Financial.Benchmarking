...
namespace SFB.Web.UI.Models
{
    ...
    public class TrustCharacteristicsViewModel : ViewModelBase
    {
        ...
        private List<SchoolCharacteristic> BuildTrustCharacteristics(SponsorViewModel schoolVM)
        {
            ...
            list.Add(new SchoolCharacteristic() { Question = TrustCharacteristicsQuestions.NUMBER_OF_PUPILS, Value = latestTrustData.PupilCount + " pupils" });
            list.Add(new SchoolCharacteristic() { Question = TrustCharacteristicsQuestions.NUMBER_OF_SCHOOLS, Value = latestTrustData.SchoolCount + " schools" });
            list.Add(new SchoolCharacteristic() { Question = TrustCharacteristicsQuestions.TOTAL_EXPENDITURE, Value = latestTrustData.TotalExpenditure.ToString() });
