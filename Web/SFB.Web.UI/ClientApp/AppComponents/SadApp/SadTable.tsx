...
import {isOfstedRating, isProgressScore, OfstedRating, ProgressScore} from "../Helpers/OutcomesHelpers";
import {SadHelpText, SadThreshold} from "../SadTrustApp/Models/sadTrustTablesModels";
  ...
  columnHelper.accessor('rating', {
    cell: info => {
      const ratingText = info.getValue()?.RatingText ?
          info.getValue()?.RatingText : <>Not available <br/><a href='#'>Add data</a></>;
      return (
