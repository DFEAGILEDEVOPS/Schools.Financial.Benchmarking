...
namespace SFB.Web.UI.Services
{
    ...
    {
        void PopulateHistoricalChartsWithSchoolData(List<ChartViewModel> historicalCharts, List<FinancialDataModel> financialDataModels, string term, RevenueGroupType revgroup, UnitType unit, EstabType estabType);
